  ...
  return (
    <div>
      ...
      <div style={{padding:'16px'}}>
        ...
        <p style={{marginTop:'16px',marginBottom:'16px'}}><img src={tick} alt='tick' style={{width:'16px'}}/> 챌린지 기간</p>
        <div className={styles.Weeks}>
          <div
            className={day === 7 ? styles.SelectWeeks : styles.SelectWeekX} 
            value={period} 
            onClick={()=>{setPeriod(7);setDay(7);
          ...
          <div
            ...
            value={period} 
            onClick={()=>{setPeriod(14);setDay(14);
                          setList((list)=>({...list,Njoo:1}));}}>
            <p>2주</p>
          </div>
          <div
            ...
            value={period} 
            onClick={()=>{setPeriod(21);setDay(21);
                          setList((list)=>({...list,Njoo:1}));}}>
            <p>3주</p>
          </div>
          <div
            ...
            value={period} 
            onClick={()=>{setPeriod(28);setDay(28);
                          setList((list)=>({...list,Njoo:1}));}}>
            <p>4주</p>
          </div>
          <div
            ...
            value={period} 
            onClick={()=>{setPeriod(35);setDay(35);
                          setList((list)=>({...list,Njoo:1}));}}>
            <p>5주</p>
          </div>
          <div
            ...
            value={period} 
            onClick={()=>{setPeriod(42);setDay(42);
                          setList((list)=>({...list,Njoo:1}));}}>
            <p>6주</p>
          </div>
        </div>
        <p style={{marginTop:'16px',marginBottom:'16px'}}><img src={tick} alt='tick' style={{width:'16px'}}/> 챌린지 시작일</p>
        ...
        <div>
          <p style={{marginTop:'16px',marginBottom:'16px'}}><img src={tick} alt='tick' style={{width:'16px'}}/> 예상 챌린지 기간</p>
