  ...
  function LimitFalse(){
    return(
      <div className={styles.False} >
        <p style={{marginTop:'16px',marginBottom:'16px'}}><img src={tick} alt='tick' style={{width:'16px'}}/> 제한 인원</p>
    ...
    return(
      <div className={styles.True} >
        ...
        <div className={styles.LimitTF}>
          <p>총</p>
          <div className={styles.People}>
            <svg disabled={!tF} onClick={minus} xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-dash" viewBox="0 0 16 16">
              <path d="M4 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 4 8z"/>
            </svg>
            <p style={{display:'flex',alignItems:'center'}}>{people}</p>
            <svg disabled={!tF} onClick={plus} xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
              <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
            </svg>
          </div>
          <p>명</p>
  ...
  return(
    <div>
      ...
      <div style={{padding:'16px'}}>
        ...
        <p style={{marginTop:'16px',marginBottom:'16px'}}><img src={tick} alt='tick' style={{width:'16px'}}/> 인원 제한 여부</p>
