...
import Contract from '../../../plugins/conectContract';
...
function CreateFinal({selects,formCnt,setFormCnt}){
  ...
  function CreateButton(){
    return(
      <button className={CreateButtonStyles.NextButton} onClick={()=>{Contract.getAllChallenge().then(console.log);}}>챌린지 발행하기</button>
    )
  }
